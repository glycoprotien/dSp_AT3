    ...
    def get_summary(self,):
        ...
        if self.serie is not None:
            summary = pd.DataFrame({
                'Description': ['Unique Values', 'Missing Values', 'Mean', 'Standard Deviation', 'Min', 'Max', 'Median', 'Zeros', 'Negatives'],
                'Value': [self.n_unique, self.n_missing, self.col_mean, self.col_std, self.col_min, self.col_max, self.col_median, self.n_zeros, self.n_negatives]
            })
            return summary
